...
//     this.variableIds = [...this.variableIds, [variableId, value ?? undefined]];
//     return this.variableIds.map((item) => item[0]);
//   }

//   public addVariableValue(variableId: string, value: string) {
//     const index = this.getVariableIndex(variableId);
//     this.variableIds[index][1] = value;
//     return this.variableIds.map((item) => item[0]);
//   }

//   public async removeVariable(variableId: string) {
//     // Remove from variables
//     this.variableIds = this.variableIds.filter((item) => item[0] !== variableId);
...
//     return this.variableIds.map((item) => {
//       const value = item[1];
//       if (value === undefined) {
...
//     const index = this.variableIds.findIndex((item) => item[0] === variableId);
...
//     if (param.variableId) {
//       param.value = self.getVariableFCValue(param.variableId);
//       return;
//     }
...
//         if (index !== -1) {
//           call.validator.params[key] = self.getVariableFCValue(self.variable[index][0]);
//         }
//       });
...
//                 if (item2.variableId) {
//                   item2.value = self.getVariableFCValue(item2.variableId);
//                 }
...
//               if (item.variableId) {
//                 item.value = self.getVariableFCValue(item.variableId);
//               }
