...
import { FCTCall, IBatchMultiSigCallFCT, IMSCallInput, IWithPlugin } from "../types";
export declare function create(this: BatchMultiSigCall, callInput: FCTCall): Promise<IMSCallInput[]>;
