...
const getMethodInterface = (call) => {
    ...
    return new utils$1.Interface(ABI).getFunction(call.method).format();
};
...
export { BatchMultiSigCall, FCTMulticall, index$2 as constants, index as utils, index$1 as variables };
