...
const getMulticallContract = (chainId, provider) => {
    const multicallAddress = constants_2.multicallContracts[chainId];
    if (!multicallAddress) {
...
const getData = async ({ chainId, provider }) => {
    ...
    const actuatorAddress = constants_1.addresses[chainId].Actuator;
    if (!poolAddress) {
    ...
    const Actuator = Interfaces_1.Interfaces.FCT_Actuator;
...
//# sourceMappingURL=getKIROPrice.js.map