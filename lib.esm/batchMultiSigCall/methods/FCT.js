import { ERC20, Erc20Approvals, TokensMath } from "@kiroboio/fct-plugins";
...
export async function create(call) {
...
export async function createMultiple(calls) {
    const callsCreated = [];
...
export async function addAtIndex(call, index) {
...
export function createPlugin({ plugin, initParams, }) {
...
export function getCallByNodeId(nodeId) {
...
export function getIndexByNodeId(nodeId) {
...
export async function exportWithApprovals() {
...
export async function exportWithPayment(payer) {
    const FCTData = this.exportFCT();
    const FCT = BatchMultiSigCall.from(FCTData);
...
export function exportNotificationFCT() {
...
export function importFCT(fct) {
    return impFCT.call(this, fct);
}
export function importFCTWithMap(fct, map) {
    return impFCT.call(this, fct, map);
}
export function impFCT(fct, map) {
