...
}): import("@kiroboio/fct-plugins").NewPluginType<"UNISWAP", "ACTION", "removeLiquidity", string, {
    input: {
        to: import("@kiroboio/fct-plugins").FctAddress;
        methodParams: {
            tokenA: import("@kiroboio/fct-plugins").FctAddress;
            tokenB: import("@kiroboio/fct-plugins").FctAddress;
            liquidity: import("@kiroboio/fct-plugins").FctValue;
            amountAMin: import("@kiroboio/fct-plugins").FctValue;
            amountBMin: import("@kiroboio/fct-plugins").FctValue;
            to: import("@kiroboio/fct-plugins").FctAddress;
            deadline: import("@kiroboio/fct-plugins").FctTimestamp;
        };
    };
    output: {
        amountA: import("@kiroboio/fct-plugins").FctValue;
        amountB: import("@kiroboio/fct-plugins").FctValue;
    };
}, Partial<{
